...
export const emiBanks: BankData[] = [
  ...
  // ============ YES BANK ============
  {
    ...
    uniqueAngle: 'Yes Bank is one of the few mid-size private banks willing to do "non-standard" income profiles — gig workers with platform earnings (Zomato, Swiggy, Urban Company), crypto-trader filings, and freelance professionals — at competitive rates.',
    productHighlights: [
  ...
  // ============ DCB BANK ============
  {
    ...
    uniqueAngle: 'DCB Bank is unusually focused on tier-2/3 city retail lending for a private bank — branch network deliberately built away from Mumbai-Delhi-Bangalore metro saturation. For tier-2/3 city buyers in Maharashtra (Aurangabad, Nashik, Solapur, Kolhapur), Gujarat (Rajkot, Vadodara outer), and Andhra Pradesh (Vijayawada, Tirupati), DCB offers more relationship-based underwriting than HDFC/ICICI without the slower processing of PSU banks.',
    productHighlights: [
  ...
  // ============ NORTH EAST SFB ============
  {
    ...
    processingFee: '1-2% of loan amount (min ₹5,000) for home loans.',
    prepaymentPolicy: 'Zero on floating-rate retail home loans post-12 EMIs.',
    marketContext: 'North East Small Finance Bank (NESFB), headquartered in Guwahati, Assam, started as RGVN North East Microfinance Limited (a microfinance NBFC since 2008) and became an SFB in 2017. NESFB is the only Small Finance Bank with Northeast-India-focused operations — about 230 banking touchpoints concentrated in Assam, Arunachal Pradesh, Manipur, Meghalaya, Mizoram, Nagaland, Sikkim, and Tripura. Total advances around ₹6,000 crore. The bank serves a uniquely underbanked geography with limited commercial bank presence.',
