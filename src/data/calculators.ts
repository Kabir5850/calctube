...
export const calculators: Calculator[] = [
  ...
  },
  {
    ...
    description: 'Old vs New regime with state Professional Tax & HRA, across all 16 states.',
    category: 'finance',
  ...
  },
  {
    ...
    description: 'Gratuity under the 1972 Act with the ₹20 lakh exemption.',
    category: 'finance',
    keywords: ['gratuity', 'payment of gratuity act', 'india'],
    icon: '💼',
    status: 'live',
  },
  {
    ...
    name: 'EPF Calculator',
    description: 'Provident fund corpus at retirement, with the EPS split.',
    category: 'finance',
    keywords: ['epf', 'provident fund', 'epfo', 'india'],
    icon: '🏦',
    status: 'live',
  },
  {
    ...
    name: 'NPS Calculator',
    description: 'Pension corpus at 60 with the 40% annuity split.',
    category: 'finance',
    keywords: ['nps', 'national pension system', 'india'],
    icon: '🪷',
    status: 'live',
  },
  {
    slug: 'sukanya-samriddhi-calculator',
    href: '/finance/sukanya-samriddhi-calculator/',
    name: 'Sukanya Samriddhi Calculator',
    description: 'SSY maturity at 21 years, including the 6 deposit-free years.',
    category: 'finance',
    keywords: ['sukanya samriddhi', 'ssy', 'girl child', 'india'],
    icon: '🌸',
    status: 'live',
  },
  {
    ...
    description: 'One-time investment growth, plus its value in today’s money.',
    category: 'finance',
    keywords: ['lumpsum', 'mutual fund', 'one-time investment'],
    icon: '📈',
    status: 'live',
  },
  {
    ...
    description: 'Compound annual growth rate between any two values.',
    category: 'finance',
    keywords: ['cagr', 'compound annual growth rate', 'returns'],
    icon: '📊',
    status: 'live',
  },
  {
